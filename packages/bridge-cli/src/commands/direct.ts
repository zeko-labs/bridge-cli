...
const MINA_TO_ZEKO_ROUTE = { from: MINA_NETWORKS.testnet, to: ZEKO_M_NETWORKS.testnet } as const
const ZEKO_TO_MINA_ROUTE = { from: ZEKO_M_NETWORKS.testnet, to: MINA_NETWORKS.testnet } as const
